...
const About = () => {
  ...
  const cardClass = isDark
    ...
    : "glass-card bg-white border border-gray-200 shadow-sm p-6 rounded-2xl";
  const tMuted = isDark ? "text-gray-300" : "text-gray-700";
  const tSub = isDark ? "text-gray-400" : "text-gray-600";

  return (
    <div
      className={`flex h-screen font-inter overflow-hidden ${
        isDark
      ...
      <div className="flex-1 flex flex-col p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className={cardClass}>
            ...
            <p className={`${tMuted} leading-relaxed`}>
            ...
            <p className={`${tSub} mt-3 text-sm leading-relaxed`}>
          ...
          <div className={cardClass}>
            ...
            <ul className={`list-disc list-inside space-y-1.5 text-sm ${tMuted}`}>
          ...
          <div className={`${cardClass} md:col-span-2`}>
            ...
            <p className={`text-sm leading-relaxed mb-3 ${tMuted}`}>
          ...
          <div className={cardClass}>
            ...
            <ul className={`list-disc list-inside space-y-1.5 text-sm ${tMuted}`}>
              ...
              <li>Automated narratives that summarize exposure, risk, and recommended next steps for each profile.</li>
